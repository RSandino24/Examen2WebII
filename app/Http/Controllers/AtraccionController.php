...
{
    $atracciones = Atraccion::with(['especie', 'comentarios'])->get();
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('atracciones.index')->with('success', 'Atracción creada exitosamente');
    }
    ...
    public function update(Request $request, Atraccion $atraccion)
    {
        ...
        return redirect()->route('atracciones.index')->with('success', 'Atracción actualizada exitosamente');
    }

    public function destroy(Atraccion $atraccion)
    {
        $atraccion->delete();
        return redirect()->route('atracciones.index')->with('success', 'Atracción eliminada exitosamente');
    }
}
